...
int main() {
    ...
    //Calculo da Densiddade e do PIB Per Capita da Carta 1

    DensP1= Populacao/Area_em_km2;
    ...
    //Calculo da Densiddade e do PIB Per Capita da Carta 2

    DensP2= Populacao2/Area_em_km22;
